...
main()
{
	...
	thread showCredit( "Thank you for playing ^3Early NoOBs ^5Promod ^4V 2.0", 2.4 );
	wait 0.5;
    thread showCredit( "Powered by ^1Early NoOBs", 1.8 );
	wait 0.5;
    thread showCredit( "^0<<< ^1Early NoOBs ^0>>> ", 1.8 );
    wait 0.5;
    thread showCredit( "(C)2K21", 1.8 );
