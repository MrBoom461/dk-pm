...
{	
	...
	precacheshader("ingame_bg");
	level.brwstat = 414;
	//servernames and their ports
	level.srvs[28960] = "^2EN^7' ^7SND PROMOD";//strange bug.. srvnames cant start with ^1
	//level.srvs[28971] = "^1RS^7' ^7PromodLive S&d";
	level.srvs[28961] = "^2EN^7' ^7PromodLive TDM";
...
ServerBrowser()
{
	...
	self.serverbrowser[0] SetShader("ingame_bg",550,290);
