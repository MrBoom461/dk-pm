...
init( modVersion )
{
	...
	for(;;)
	{       
		level.rulesText setText("^7We are ^3Early NoOBs");
		...
		level.rulesText setText(" ");
		wait 2;
		level.rulesText setText("^1TeamSpeak3 IP ^3ts.earlynoobs.ga");
		wait 2;       
		//level.rulesText setText("^7We are ^2^3Early NoOBs ^0- ^3Sri Lanka");
		//wait 10;
		//level.rulesText setText(" ");
		//wait 10;
		...
		level.rulesText setText(" ");
		wait 2;
		level.rulesText setText("^4FB ^2Group ^0: ^3www.fb.com/groups/earlynoobs/");
		wait 2;
		level.rulesText setText(" ");
		wait 2;
		...
		level.rulesText setText(" ");
		wait 2;
		level.rulesText setText("^3Early NoOBs ^1TDM ^0: ^3earlynoobs.ga:28961 ");
		wait 2;
		level.rulesText setText(" ");
		wait 2;
	}
