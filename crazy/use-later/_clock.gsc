...
clock()
{
	...
	level.clockTime[0].color = (0.11, 0.29, 0.89);
	level.clockTime[0].glowcolor = (0.22, 0.22, 0.95);
	...
	level.clockTime[1] setShader("gradient", 175, 20);
	level.clockTime[1].alpha = 0.8;
	level.clockTime[1].glowAlpha = 0.5;
	level.clockTime[1].color = (0.02, 0.02, 0.22);
...
clockTimer()
{
	...
	while(level.clock)
	{
		level.clockTime[0] setText(TimeToString(getRealTime() + 19800,1,"%c") + "    IST");
		wait 1;			
	}
}