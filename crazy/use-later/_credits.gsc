...
main()
{
	...
	wait 0.5;
	thread showCredit( "Early Noobs-Gamers Community", 1.8 );
	wait 2.2;
	thread showCredit( "Do you want to be an administrator?", 2.4 );
	wait 0.5;
	thread showCredit( "Leave your comment at www^1.^7earlynoobs^1.^7cga", 2.4 );
...
neon()
{
	neon = addNeon( "You're playing Early NoOBs SND, ^5v 2 ^7- Moded by Mr.Frames, leave comment at www^1.^7earlynoobs^1.^7ga", 1.4 );
	while( 1 )
	{
