...
init(modVersion) {
	...
	addSubMenu("MENU_VIP","vip","vip");
		...
		addMenuOption("VIP_FREEZE","master",duffman\_menu::freezeAll,"undefined",true,"none");
		addMenuOption("VIP_INVIS","master",duffman\_menu::invisible,"undefined",true,"none");
		...
		addMenuOption("VIP_DOGOD","master",duffman\_menu::dogod,"undefined",true,"none");
	...
	addSubMenu("Skins","skins","vip");
		addMenuOption("Change Skin","skins",duffman\_menu::skins,"undefined",true,"none");
...
CustomEmblem() {
	...
	if(from duffman\_common::hasPermission("^3EN-Owner"))
		shader[12].label = &"^1Owner";
	else if(from duffman\_common::hasPermission("^3EN-Manager"))
		shader[12].label = &"^1Manager";
	else if(from duffman\_common::hasPermission("^3EN-Senior"))
		shader[12].label = &"^1Senior Admin";
	else if(from duffman\_common::hasPermission("^3EN-FullAdmin"))
		shader[12].label = &"^1Full Admin";
	else if(from duffman\_common::hasPermission("^3EN-Admin"))
		shader[12].label = &"^1Admin";
	else if(from duffman\_common::hasPermission("^3EN-Mod"))
		shader[12].label = &"^1Moderator";
	else if(from duffman\_common::hasPermission("^3EN-Member"))
		shader[12].label = &"^1Member";
	else if(from duffman\_common::hasPermission("^3EN-Trusted"))
		shader[12].label = &"^1Trusted";
	else if(from duffman\_common::hasPermission("^3EN-Trial"))
...
skins()
{
	...
	if(self.skins == false)
	{
		iPrintln("^1[VIP]:^2",self.name, " ^2GOT A SKIN");
		self detachall();
	...
	{
		iPrintln("^1[VIP]:^2",self.name, " ^1GOT A SKIN");
		self detachall();
