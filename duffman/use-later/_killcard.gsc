...
ShowKillCard(attacker,victim,sMeansOfDeath,sWeapon,sHitLoc) {
	if(isDefined(attacker) && isDefined(victim) && isPlayer(attacker) && isPlayer(victim) && attacker != victim && isDefined(sMeansOfDeath) && isDefined(sWeapon) && !isDefined(attacker.pers["isBot"]) && 
!isDefined(victim.pers["isBot"])) {
