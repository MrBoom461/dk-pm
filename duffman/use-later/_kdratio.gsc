...
ShowKDRatio()
{
	...
	if( IsDefined( self.Notify ) )     self.Notify Destroy();
	...
	self.Notify.horzAlign = "right";
        self.Notify.vertAlign = "bottom";
        self.Notify.alignX = "right";
        self.Notify.alignY = "bottom";
	//self.Notify.alignX = "right";
	//self.Notify.horzAlign = "right";
	//self.Notify.alignY = "bottom";
	self.Notify setShader( "en_notify" + card, 220, 55 );
	...
	wait time;
	self.Notify moveOverTime(0.5);
	self.Notify.x = 34;
	wait 6;
        self.Notify moveOverTime(0.9);
        self.Notify.x = 300;
	wait 1;
