...
// Kninferound Music : Only kniferound1 added
playMusic()
{
	randomsong = (1+randomInt(5));
	self playLocalSound( "kniferound" + randomsong );
}
